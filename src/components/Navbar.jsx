...
const Navbar = () => {
      ...
      {!user && (
        <>
          <li
            ...
            className={`my-2 px-3 py-1 rounded-md cursor-pointer transition-colors duration-200 btn-secondary ${location.pathname === "/login"
              ? "text-white bg-[#00BFA6]"
              : "text-[#00BFA6] "
              }`}
          >
            Login
          ...
          <li
            ...
            className={`my-2 px-3 py-1 rounded-md cursor-pointer transition-colors duration-200 btn-secondary ${location.pathname === "/register"
              ? "text-white bg-[#00BFA6]"
              : "text-[#00BFA6] "
              }`}
          >
      ...
      {user && (
        <>
          ...
          <li
            ...
            className={`my-2 px-3 mr-3 py-1 rounded-md cursor-pointer transition-colors duration-200 btn-secondary ${location.pathname === "/dashboard"
                ? "text-white bg-[#00A8E7]"
                : "text-[#00A8E7]"
              }`}
          >
  ...
  return (
    <div className="sticky top-0 bg-black backdrop-blur border-b border-gray-700 z-50">
      <div className="relative sm:w-9/12 mx-auto">
        {loading && (
